...
public sealed class TeamStatisticsResponse
{
    ...
    public TeamStatisticsPoints? Points { get; init; }
}
...
public sealed class TeamStatisticsGames
{
    ...
    public StatHomeAwayAll<StatTotalPercentage>? Draws { get; init; }

    [JsonPropertyName("loses")]
    public StatHomeAwayAll<StatTotalPercentage>? Loses { get; init; }
}

public sealed class TeamStatisticsPoints
{
    [JsonPropertyName("for")]
    public TeamStatisticsPointsBreakdown? For { get; init; }

    [JsonPropertyName("against")]
    public TeamStatisticsPointsBreakdown? Against { get; init; }
}

public sealed class TeamStatisticsPointsBreakdown
{
