...
public static class BasketballEndpointCatalog
{
    public static IReadOnlyList<EndpointDefinition> Endpoints { get; } = new List<EndpointDefinition>
    {
        ...
        new(typeof(TeamsClient), nameof(TeamsClient.GetStatisticsAsync), "/statistics", "get", "teams/statistics.json"),
        ...
        new(typeof(PlayersClient), nameof(PlayersClient.GetAsync), "/players", "get", "players.json"),
        new(typeof(OddsClient), nameof(OddsClient.GetAsync), "/odds", "get", "odds/odds.json"),
        new(typeof(OddsClient), nameof(OddsClient.GetBetsAsync), "/bets", "get", "odds/bets.json"),
        new(typeof(OddsClient), nameof(OddsClient.GetBookmakersAsync), "/bookmakers", "get", "odds/bookmakers.json"),
    };
