...
public static class NflEndpointCatalog
{
    public static IReadOnlyList<EndpointDefinition> Endpoints { get; } = new List<EndpointDefinition>
    {
        ...
        new(typeof(StandingsClient), nameof(StandingsClient.GetConferencesAsync), "/standings/conferences", "get", "standings/conferences.json"),
        new(typeof(StandingsClient), nameof(StandingsClient.GetDivisionsAsync), "/standings/divisions", "get", "standings/divisions.json"),
