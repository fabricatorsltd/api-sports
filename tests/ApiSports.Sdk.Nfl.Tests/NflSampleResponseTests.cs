...
public sealed class NflSampleResponseTests
{
    ...
    {
        (bool found, string? json) = SampleJsonLoader.TryLoadNflSample(endpoint.Definition.SamplePath);
    ...
    {
        NflJsonSerializerContext context = NflJsonSerializerContext.Default;
        ...
        [
            ...
            new SampleEndpoint<PlayerSeasonStatistics[]>(GetDefinition(typeof(PlayersClient), nameof(PlayersClient.GetStatisticsAsync)), context.ApiResponsePlayerSeasonStatisticsArray),
            ...
            new SampleEndpoint<GameEvent[]>(GetDefinition(typeof(GamesClient), nameof(GamesClient.GetEventsAsync)), context.ApiResponseGameEventArray),
            new SampleEndpoint<GameTeamStatistics[]>(GetDefinition(typeof(GamesClient), nameof(GamesClient.GetTeamStatisticsAsync)), context.ApiResponseGameTeamStatisticsArray),
            new SampleEndpoint<GamePlayerStatistics[]>(GetDefinition(typeof(GamesClient), nameof(GamesClient.GetPlayerStatisticsAsync)), context.ApiResponseGamePlayerStatisticsArray),
            ...
            new SampleEndpoint<string[]>(GetDefinition(typeof(StandingsClient), nameof(StandingsClient.GetConferencesAsync)), context.ApiResponseStringArray),
            new SampleEndpoint<string[]>(GetDefinition(typeof(StandingsClient), nameof(StandingsClient.GetDivisionsAsync)), context.ApiResponseStringArray),
    ...
    private static EndpointDefinition GetDefinition(Type clientType, string methodName)
    {
        ...
        if (!NflEndpointCatalog.EndpointByMethod.TryGetValue(key, out EndpointDefinition? definition))
        {
