...
public static class FootballEndpointCatalog
{
    ...
    [
        ...
        new(typeof(FixturesClient), nameof(FixturesClient.GetRoundsWithDatesAsync), "/fixtures/rounds", "get", "fixtures/rounds-with-dates.json"),
        ...
        new(typeof(PlayersClient), nameof(PlayersClient.GetProfilesAsync), "/players/profiles", "get", "players/profiles.json"),
